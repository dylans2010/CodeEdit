...
struct NavigatorSidebarToolbarTop: View {
    ...
    @State private var icons = [
        SidebarDockIcon(imageName: "folder", title: "Project", id: 0, disabled: false),
        SidebarDockIcon(imageName: "vault", title: "Version Control", id: 1, disabled: false),
        SidebarDockIcon(imageName: "magnifyingglass", title: "Search", id: 2, disabled: false),
        SidebarDockIcon(imageName: "shippingbox", title: "Dependencies", id: 3, disabled: false),
        SidebarDockIcon(imageName: "play.circle", title: "Tests", id: 4, disabled: false),
        SidebarDockIcon(imageName: "exclamationmark.triangle", title: "Issues", id: 5, disabled: false),
        SidebarDockIcon(imageName: "curlybraces.square", title: "Symbols", id: 6, disabled: false),
        SidebarDockIcon(imageName: "puzzlepiece.extension", title: "Extensions", id: 7, disabled: false),
        SidebarDockIcon(imageName: "square.grid.2x2", title: "Utilities", id: 8, disabled: false)
    ]
